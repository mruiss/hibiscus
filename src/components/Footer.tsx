        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              <a className="w-9 h-9 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/20 flex items-center justify-center transition" aria-label="Instagram">
                <Instagram className="w-4 h-4" strokeWidth={1.5} />
              </a>
              <a className="w-9 h-9 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/20 flex items-center justify-center transition" aria-label="Email">
